...
public class FileStatusTracker
{
    ...
    private static final int WRITE_INTERVAL = 60000;

    private static final String FILE_PATH = "data/filestatuses.txt";
    ...
    public static Future<Void> loadStatusFromFile()
    {
    ...
    public static void writeStatusToFile()
    {
        try
        {
